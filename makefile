...
bin/app: obj/main.o obj/construction.o obj/geoapp.o obj/geo.o obj/input.o obj/geoImpl.o
	g++ obj/main.o obj/construction.o obj/geoapp.o obj/geo.o obj/input.o obj/geoImpl.o -o bin/app -lsfml-window -lsfml-system -lsfml-graphics $(CFLAGS)
...
clean:
	rm obj/main.o obj/construction.o obj/geoapp.o obj/geo.o obj/input.o obj/geoImpl.o
